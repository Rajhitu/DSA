...
(i.e. 5x7-3x5+x2+9) and display the polynomial by using user defined functions for creation 
and display.Write a program to add and multiply two polynomials with single varia
ble with a new function for addition and multiplication operations.
*/
#include <math.h>
#include <stdio.h>
#include <stdlib.h>
